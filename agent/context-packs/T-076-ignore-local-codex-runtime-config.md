# T-076: Ignore local Codex runtime config

Type: `implementation`
Originating DCR: `DCR-0046`

## Goal

Ignore local Codex runtime config

## Requirements

- `R-181` Local Codex runtime config is ignored while generated Codex agent roles stay trackable (P2, medium)
...
- `docs/change-requests/DCR-0046-ignore-local-codex-runtime-config.md`
...
| Path | Provenance |
|---|---|
| `.gitignore` | confirmed; code target |
| `agent/context-packs/T-076-ignore-local-codex-runtime-config.md` | inferred; support artifact |
| `agent/reviews/REVIEW-0013.yml` | inferred; support artifact |
| `agent/task-ledger.yml` | confirmed; support artifact |
| `docs/change-requests/DCR-0046-ignore-local-codex-runtime-config.md` | confirmed; support artifact |
