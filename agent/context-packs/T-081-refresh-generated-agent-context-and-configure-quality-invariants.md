# T-081: Refresh generated agent context and configure quality invariants

Type: `implementation`

## Goal

Refresh generated agent context and configure quality invariants

## Requirements

- `R-186` Generated agent context stays current and project invariants are configured (P1, medium)
...
- `agent/context-packs/T-081-refresh-generated-agent-context-and-configure-quality-invariants.md`
- `agent/handoff.yml`
- `agent/reviews/*.yml`
- `agent/task-ledger.yml`
- `docs/change-requests/DCR-0051-refresh-generated-agent-context-and-configure-quality-invariants.md`
...
| Path | Provenance |
|---|---|
| `.claude/agents/*.md` | pattern; code target |
| `.claude/skills/**/SKILL.md` | pattern; code target |
| `.codex/agents/*.toml` | pattern; code target |
| `AGENTS.md` | confirmed; code target |
| `CLAUDE.md` | confirmed; code target |
| `agent/policies/invariants.yml` | inferred; code target |
| `agent/roles/*.md` | pattern; code target |
| `agentspec/emit.py` | confirmed; code target |
| `reports/quality/latest.md` | confirmed; code target |
| `reports/quality/latest.yml` | confirmed; code target |
| `agent/context-packs/T-081-refresh-generated-agent-context-and-configure-quality-invariants.md` | inferred; support artifact |
...
| `docs/change-requests/DCR-0051-refresh-generated-agent-context-and-configure-quality-invariants.md` | confirmed; support artifact |
...
- aspec emit --target claude,codex produces an AGENTS.md that includes the code-review gate, current status counts, and latest handoff command.
- Generated Claude and Codex role files are refreshed and include the current quality-gc role surface.
- agent/policies/invariants.yml exists and aspec doctor reports project_invariants.status=passed.
- aspec quality --json no longer reports agent-context freshness warnings or missing invariant configuration.
