# T-088: Enforce workflow-pack contract and roadmap generation
...
Enforce workflow-pack contract and roadmap generation
...
| `agentspec/roadmap.py` | inferred; code target |
| `agentspec/status.py` | confirmed; code target |
| `agentspec/task.py` | confirmed; code target |
| `agentspec/workflow.py` | inferred; code target |
| `agent/context-packs/T-088-enforce-workflow-pack-contract-and-roadmap-generation.md` | inferred; support artifact |
| `agent/context-packs/_TEMPLATE.md` | inferred; support artifact |
...
| `docs/ROADMAP.md` | inferred; support artifact |
| `docs/change-requests/DCR-0058-enforce-workflow-pack-contract-and-roadmap-generation.md` | confirmed; support artifact |
...
| `tests/test_workflow_contract.py` | inferred; task verification |
