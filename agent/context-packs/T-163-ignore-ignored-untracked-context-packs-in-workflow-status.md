# T-163: Ignore ignored untracked context packs in workflow status
...
Ignore ignored untracked context packs in workflow status
...
- `agent/context-packs/T-163-ignore-ignored-untracked-context-packs-in-workflow-status.md`
- `agent/workflows/W-163-ignore-ignored-untracked-context-packs-in-workflow-status.md`
...
| `agent/context-packs/T-163-ignore-ignored-untracked-context-packs-in-workflow-status.md` | inferred; lifecycle write-back |
| `agent/workflows/W-163-ignore-ignored-untracked-context-packs-in-workflow-status.md` | inferred; lifecycle write-back |
