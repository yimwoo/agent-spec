# T-062: Short aspec plugin skill prefix

Type: `implementation`
Originating DCR: `DCR-0032-short-aspec-plugin-skill-prefix`

## Goal

Short aspec plugin skill prefix

## Requirements

- `R-167` Codex plugin uses short aspec skill prefix (P1, medium)
...
- `agent/context-packs/T-062-short-aspec-plugin-skill-prefix.md`
- `agent/task-ledger.yml`
- `agentspec-codex-plugin/**`
- `docs/change-requests/DCR-0032-short-aspec-plugin-skill-prefix.md`
...
| Path | Provenance |
|---|---|
| `agent/context-packs/T-062-short-aspec-plugin-skill-prefix.md` | confirmed; active implementation pack |
| `agent/task-ledger.yml` | confirmed; task status projection |
| `agentspec-codex-plugin/**` | pattern; code target |
| `docs/change-requests/DCR-0032-short-aspec-plugin-skill-prefix.md` | confirmed; originating DCR |
...
- Local installed plugin/cache/marketplace are refreshed under the aspec identity.
- Codex prompt discovery exposes aspec:* skills and does not expose agentspec-codex-plugin:*.
