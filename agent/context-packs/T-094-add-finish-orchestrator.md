...
| `agent/context-packs/T-094-add-finish-orchestrator.md` | inferred; support artifact |
...
| `docs/change-requests/DCR-0063-add-finish-orchestrator.md` | confirmed; support artifact |
...
| `tests/test_finish_cli.py` | inferred; task verification |
