# T-080: Close next stale answered open questions

Type: `implementation`

## Goal

Close next stale answered open questions

## Requirements

- `R-185` Next stale answered open questions cite accepted decision evidence (P2, medium)
...
| `agent/context-packs/T-080-close-next-stale-answered-open-questions.md` | inferred; support artifact |
...
| `docs/change-requests/DCR-0050-close-next-stale-answered-open-questions.md` | confirmed; support artifact |
...
- Q-009 has status answered with answered_by DCR-0033/R-168; R-104.
- Q-015 has status answered with answered_by ADR-0002; docs/change-requests/README.md.
- Existing impact, source_sections, and raised_by metadata on both entries is preserved.
