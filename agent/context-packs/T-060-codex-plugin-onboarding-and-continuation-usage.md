# T-060: Codex plugin onboarding and continuation usage

Type: `implementation`
Originating DCR: `DCR-0030-plugin-onboarding-and-continuation-usage`

## Goal

Codex plugin onboarding and continuation usage

## Requirements

- `R-165` Codex plugin documents init and continue workflows (P1, medium)
...
- `agent/context-packs/T-060-codex-plugin-onboarding-and-continuation-usage.md`
- `agent/task-ledger.yml`
- `agentspec-codex-plugin/**`
- `docs/change-requests/DCR-0030-plugin-onboarding-and-continuation-usage.md`
...
| Path | Provenance |
|---|---|
| `agent/context-packs/T-060-codex-plugin-onboarding-and-continuation-usage.md` | confirmed; active implementation pack |
| `agent/task-ledger.yml` | confirmed; task status projection |
| `agentspec-codex-plugin/**` | pattern; code target |
| `docs/change-requests/DCR-0030-plugin-onboarding-and-continuation-usage.md` | confirmed; originating DCR |
...
- Plugin README shows CLI and plugin paths for continuing work in an existing AgentSpec repository.
- Plugin skills include discoverable descriptions for init/new-repo and continue-existing-repo workflows.
- Tests verify the plugin package includes the init, continue, status, and manual source-intake guidance.
