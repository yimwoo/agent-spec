# T-165: Report broken workflow link source paths
...
Report broken workflow link source paths
...
- `agent/context-packs/T-165-report-broken-workflow-link-source-paths.md`
- `agent/workflows/W-165-report-broken-workflow-link-source-paths.md`
...
| `agent/context-packs/T-165-report-broken-workflow-link-source-paths.md` | inferred; lifecycle write-back |
| `agent/workflows/W-165-report-broken-workflow-link-source-paths.md` | inferred; lifecycle write-back |
