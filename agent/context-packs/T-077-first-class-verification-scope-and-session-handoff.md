...
Type: `implementation`
Originating DCR: `DCR-0047`

## Goal

First-class verification scope and session handoff

## Requirements

- `R-182` Task packs include verification support scope and completion writes handoff state (P1, medium)
...
- `agent/context-packs/T-077-first-class-verification-scope-and-session-handoff.md`
- `agent/handoff.yml`
- `agent/reviews/*.yml`
- `agent/task-ledger.yml`
- `docs/change-requests/DCR-0047-first-class-verification-scope-and-session-handoff.md`
...
| Path | Provenance |
|---|---|
| `agentspec/handoff.py` | inferred; code target |
...
| `agent/context-packs/T-077-first-class-verification-scope-and-session-handoff.md` | inferred; support artifact |
| `agent/handoff.yml` | inferred; support artifact |
| `agent/reviews/*.yml` | pattern; verification support |
| `agent/task-ledger.yml` | confirmed; support artifact |
| `docs/change-requests/DCR-0047-first-class-verification-scope-and-session-handoff.md` | confirmed; support artifact |
...
| `tests/test_task_ledger.py` | confirmed; task verification |
...
- Newly generated task context packs include agent/reviews/*.yml, agent/task-ledger.yml, and agent/handoff.yml in Allowed Paths.
- Completing a task writes agent/handoff.yml with schema, last completed task, status counts, next action, and continuation commands.
