# T-164: Count completed ledger task requirements in status coverage
...
Count completed ledger task requirements in status coverage
...
- `agent/context-packs/T-164-count-completed-ledger-task-requirements-in-status-coverage.md`
- `agent/workflows/W-164-count-completed-ledger-task-requirements-in-status-coverage.md`
...
| `agent/context-packs/T-164-count-completed-ledger-task-requirements-in-status-coverage.md` | inferred; lifecycle write-back |
| `agent/workflows/W-164-count-completed-ledger-task-requirements-in-status-coverage.md` | inferred; lifecycle write-back |
