...
- DCRs: DCR-0001 (spike, ADR-0003 accepted; local run protocol MVP shipped), DCR-0002 / DCR-0003 / DCR-0004 / DCR-0005 / DCR-0006 / DCR-0007 / DCR-0008 / DCR-0009 / DCR-0010 / DCR-0011 / DCR-0012 / DCR-0013 / DCR-0014 / DCR-0015 / DCR-0016 / DCR-0017 (accepted)
- `agent/task-ledger.yml` is the committed queue-status projection; local `agent/runs/*` remains ignored execution detail.
- Historical context packs T-001..T-023 are marked complete in the committed task ledger; `aspec task next` should surface only new ready work.
