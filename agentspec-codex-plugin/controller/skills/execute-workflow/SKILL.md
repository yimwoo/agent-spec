...
2. Prefer provider-native execution. Use Codex Goal mode or the active Codex
...
`aspec run loop` and `aspec run exec --runner codex` remain compatibility
paths. They are not the preferred Codex execution strategy.
